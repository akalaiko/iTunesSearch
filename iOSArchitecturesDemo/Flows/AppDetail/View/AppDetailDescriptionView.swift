...
class AppDetailDescriptionView: UIView {
    ...
    func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            descriptionText.bottomAnchor.constraint(equalTo: self.versionTitle.bottomAnchor, constant: 190),
            descriptionText.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 16.0),
